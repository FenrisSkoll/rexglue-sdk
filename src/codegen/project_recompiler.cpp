...
std::string FingerprintModule(const RecompilerConfig& cfg,
  ...
  std::vector<std::string> flags{
      ...
      fmt::format("jump_table_max_predecessors={}", REXCVAR_GET(jump_table_max_predecessors)),
      fmt::format("jump_table_max_states={}", REXCVAR_GET(jump_table_max_states)),
      fmt::format("jump_table_max_cfg_topology_nodes={}",
                  REXCVAR_GET(jump_table_max_cfg_topology_nodes)),
      fmt::format("jump_table_fixpoint_iterations={}", REXCVAR_GET(jump_table_fixpoint_iterations)),
